...
public class Bookings {
	...
	public String toString() {
		return "Bookings [bookingId=" + bookingId + ", title=" + title + ", trainerUserId=" + trainerUserId
				+ ", trainer=" + trainer + ", date=" + date + ", Ftime=" + Ftime + ", Ttime=" + Ttime + ", amount="
				+ amount + ", customerUserId=" + customerUserId + ", customerName=" + customerName + ", customerEmail="
				+ customerEmail + "]";
	}
